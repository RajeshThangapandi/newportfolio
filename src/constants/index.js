...
const projects = [
  ...
  
  {
    name: "ECOMM APP",
    description:
      "The aim of this project is to optimize the mobile accessories  eCommerce platform to provide a seamless and engaging user experience, ultimately increasing sales conversion rates. This will involve a comprehensive review of the existing website, identification of pain points in the user journey, and implementation of solutions to address these issues. Additionally, the project will focus on enhancing the platform's mobile responsiveness, streamlining the checkout process, and improving product discoverability.",
    tags: [
      {
        name: "HTML",
        color: "blue-text-gradient",
...
export { services, technologies, contacts,educations, experiences, artItems, projects };
